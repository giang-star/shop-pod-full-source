                                ...
                                <div class="card-body">
                                    <form method="post" enctype="multipart/form-data" action="admin/product">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <select required name="product_category_id" id="product_category_id" class="form-control" value="{{old('product_category_id')}}">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-md-9 col-xl-8">
                                                <input required name="content" id="content"
                                                    placeholder="Content" type="text" class="form-control" value="{{old('content')}}">
                                            </div>
                                        </div>
