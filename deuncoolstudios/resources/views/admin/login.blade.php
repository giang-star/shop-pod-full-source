            ...
            <div class="h-100 bg-animation">
                <div class="d-flex h-100 justify-content-center align-items-center">
                    <div class="mx-auto app-login-box col-md-8">
                        <p class="" style="margin: 0 atuto;font-size:30px; text-align:center;font-weight:600; color: blue;">deuncoolstudios</p>
                        ...
                        <div class="text-center text-blue opacity-8 mt-3">deuncoolstudios@gmail.com</div>
                    </div>
                </div>
            </div>
        </div>
