                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body display_data">
                                    <div class="position-relative row form-group">
                                        <label for="image" class="col-md-3 text-md-center col-form-label">Avatar</label>
                                    ...
                                    <div class="position-relative row form-group">
                                        <label for="level" class="col-md-3 text-md-center col-form-label">Level</label>
                                        <div class="col-md-9 col-xl-8">
                                            <p>{{$user->level == 2 ? 'User' : 'Admin'}}</p>
                                        </div>
                                    </div>
